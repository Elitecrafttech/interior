...
import qr from '../assets/whatsqr.jpg'
    ...
    <div>
        <div data-aos="fade-up" className='abt'>
            <div className='flex lg:flex-row-reverse lg:justify-between flex-col'>
                ...
                <img data-aos="fade-up" src={img} alt="" className='lg:min-h-full min-h-[500px] lg:w-[500px] w-full'/>
                <img src={qr} alt="" className='h-[250px] lg:h-[300px] relative bottom-[380px] lg:bottom-[400px] rounded-lg'/>
                </div>
