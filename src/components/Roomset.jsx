    ...
    <div className="py-10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 max-w-lg mx-auto">
          <p className="text-sm text-primary">Explore More About Roomset</p>
          <h1 className="text-3xl font-bold">Room Set</h1>
          <p className="text-xs text-gray-400">Discover different room designs for your home.</p>
        </div>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-center gap-[5px] pb-[30px]'>
            ...
            <div className='flex flex-col gap-[5px] items-center'>
                <img src={img5} alt="" className='h-[200px] lg:h-[125px] w-[350px] rounded-xl object-cover'/>
                <img src={img1} alt="" className='h-[200px] lg:h-[125px] w-[350px] rounded-xl'/>
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
          {roomset.map((room, index) => (
            <div key={room.id} className="relative rounded-xl overflow-hidden shadow-lg">
